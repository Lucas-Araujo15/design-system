...
// src/components/TooltipPopUp/index.tsx
import * as Tooltip2 from "@radix-ui/react-tooltip";

// src/components/TooltipPopUp/styles.ts
...
function TooltipPopUp({ children, info }) {
  return /* @__PURE__ */ jsx5(Tooltip2.Provider, { children: /* @__PURE__ */ jsxs4(Tooltip2.Root, { children: [
    /* @__PURE__ */ jsx5(Tooltip2.Trigger, { asChild: true, children }),
    /* @__PURE__ */ jsx5(Tooltip2.Portal, { children: /* @__PURE__ */ jsxs4(TooltipContent, { children: [
      info,
